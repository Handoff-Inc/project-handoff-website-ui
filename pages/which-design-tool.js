        ...
        <div className="div-block-327">
          ...
          <div className="div-block-328 aaa bbb">
            ...
            <div className="wrap-section1-mu aaa aaaaa height-85vh">
              ...
              <div className="div-block-386-copy">
                <div className="div-block-387"><img src="images/Group-1000001877.svg" loading="lazy" alt="" className="image-117" />
                  <div className="text-block-80">Figma</div>
                </div>
                <div className="div-block-387"><img src="images/Group-1000001878.svg" loading="lazy" alt="" className="image-118" />
                  <div className="text-block-80">Sketch</div>
                </div>
                <div className="div-block-387"><img src="images/Group-1000001879.svg" loading="lazy" alt="" className="image-119" />
                  <div className="text-block-80">AdobeXD</div>
                </div>
              </div>
            </div>
          </div>
...
export const getStaticProps = async () => {
  const markdownWithMetadata = fs
    .readFileSync("public/content/whichDesignTool.md")
    .toString();
...
export default whichDesignTool;
