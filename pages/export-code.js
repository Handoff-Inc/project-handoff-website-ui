      ...
      <div>
        <div>
          ...
          <div className="div-block-327">
            ...
            <div className="div-block-328 aaa bbb f8f8ff gfds">
              ...
              <div className="wrap-section1-mu aaa aaaaa lkjhg">
                <div className="div-block-385-copy jhgfds">
        ...
        <div className="export-code-popup">
          <div className="div-block-389 asdasd">
            <div className="div-block-390">
              <div>
                <h1 className="heading-153 sss">Export Code</h1>
              </div>
            ...
            <div data-current="Tab 2" data-easing="ease" data-duration-in={300} data-duration-out={100} className="w-tabs">
              ...
              <div className="tabs-content w-tab-content">
                <div data-w-tab="Tab 2" className="w-tab-pane w--tab-active"><img src="images/Frame-38.png" loading="lazy" srcSet="images/Frame-38-p-500.png 500w, images/Frame-38.png 600w" sizes="(max-width: 479px) 100vw, (max-width: 767px) 84vw, 490px" alt="" className="image-103" /></div>
                <div data-w-tab="Tab 3" className="w-tab-pane"><img src="images/Frame-38.png" loading="lazy" srcSet="images/Frame-38-p-500.png 500w, images/Frame-38.png 600w" sizes="(max-width: 479px) 100vw, (max-width: 767px) 84vw, 490px" alt="" className="image-103" /></div>
                <div data-w-tab="Tab 4" className="w-tab-pane"><img src="images/Frame-38.png" loading="lazy" srcSet="images/Frame-38-p-500.png 500w, images/Frame-38.png 600w" sizes="(max-width: 479px) 100vw, (max-width: 767px) 84vw, 490px" alt="" className="image-103" /></div>
                <div data-w-tab="Tab 5" className="w-tab-pane"><img src="images/Frame-38.png" loading="lazy" srcSet="images/Frame-38-p-500.png 500w, images/Frame-38.png 600w" sizes="(max-width: 479px) 100vw, (max-width: 767px) 84vw, 490px" alt="" className="image-103" /></div>
              </div>
            </div>
...
export const getStaticProps = async () => {
  const markdownWithMetadata = fs
    .readFileSync("public/content/exportCode.md")
    .toString();
